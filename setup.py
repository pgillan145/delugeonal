...
setup(
    ...
    install_requires=['cinemagoer', 'dumper', 'fuzzywuzzy', 'minorimpact', 'parse-torrent-title', 'plexapi', 'Python-Levenshtein', 'pyyaml', 'rarfile', 'tvdb_v4_official > 1.0.7', 'bencode.py', 'xmltodict'],
    license='GPLv3',
